...
# Version:      3.00                                                #
#                                                                   #
# Changes:      Debian 12 and nftables update                       #
#               dhclient cleanup (2.20)                             #
...
get_information() {
    /usr/bin/logger 'get_information()' -t 'FW-20230914';
...
#    read -p "ALERTA API Key: "  ALERTA_APIKEY;
    ...
    /usr/bin/logger 'get_information() finished' -t 'FW-20230914';
}

configure_locale() {
    /usr/bin/logger 'configure_locale()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_locale() finished' -t 'FW-20230914';
}

configure_bind() {
    /usr/bin/logger 'configure_bind()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_bind() finished' -t 'FW-20230914';
}

configure_threatfox() {
    /usr/bin/logger 'configure_threatfox()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_threatfox() finished' -t 'FW-20230914';
}

configure_dhcp_server() {
    /usr/bin/logger 'configure_dhcp_server()' -t 'FW-20230914';
...
__EOF__
    ...
    echo -e "\e[32mconfigure_dhcp_server()\e[0m";
    /usr/bin/logger 'configure_dhcp_server() finished' -t 'FW-20230914';
}

install_dshield() {
    /usr/bin/logger 'install_dshield()' -t 'FW-20230914';
    ...
    /usr/bin/logger 'install_dshield() finished' -t 'FW-20230914';
}

configure_dshield() {
    /usr/bin/logger 'configure_dshield()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_dshield() finished' -t 'FW-20230914';
}

install_crowdsec() {
    /usr/bin/logger 'install_crowdsec()' -t 'FW-20230914';
    ...
    /usr/bin/logger 'install_crowdsec() finished' -t 'FW-20230914';
}

configure_crowdsec() {
    /usr/bin/logger 'configure_crowdsec()' -t 'FW-20230914';
    ...
    /usr/bin/logger 'configure_crowdsec() finished' -t 'FW-20230914';
}

configure_rsyslog() {
    /usr/bin/logger 'configure_rsyslog()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_rsyslog() finished' -t 'FW-20230914';
}

configure_exim() {
    /usr/bin/logger 'configure_exim()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_exim() finished' -t 'FW-20230914';
}

install_filebeat() {
    /usr/bin/logger 'install_filebeat()' -t 'FW-20230914';
    ...
    /usr/bin/logger 'install_filebeat() finished' -t 'FW-20230914';
}

configure_filebeat() {
    /usr/bin/logger 'configure_filebeat()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_filebeat() finished' -t 'FW-20230914';
}

configure_timezone() {
    /usr/bin/logger 'configure_timezone()' -t 'FW-20230914';
    ...
    /usr/bin/logger 'configure_timezone() finished' -t 'FW-20230914';
}

configure_sources() {
    /usr/bin/logger 'configure_sources()' -t 'FW-20230914';
...
configure_logrotate() {
    /usr/bin/logger 'configure_logrotate()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_logrotate() finished' -t 'FW-20230914';
}

install_prerequisites() {
    /usr/bin/logger 'install_prerequisites' -t 'FW-20230914';
    ...
    OS=$NAME
    VER=$VERSION_ID
    /usr/bin/logger "Operating System: $OS Version: $VER" -t 'FW-20230914';
    ...
    /usr/bin/logger '..Install some basic tools on a Debian net install' -t 'FW-20230914';
    ...
    /usr/bin/logger 'install_prerequisites() finished' -t 'FW-20230914';
}

configure_cpu() {
    /usr/bin/logger 'configure_cpu()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_cpu() finished' -t 'FW-20230914';
}

enable_ipforwarding() {
    /usr/bin/logger 'enable_ipforwarding()' -t 'FW-20230914';
    ...
    /usr/bin/logger 'enable_ipforwarding() finished' -t 'FW-20230914';
}

configure_resolv() {
    /usr/bin/logger 'configure_resolv()' -t 'FW-20230914';    
...
__EOF__
    ...
    /usr/bin/logger 'configure_resolv() finished' -t 'FW-20230914';    
}

install_updates() {
    echo -e "\e[32m - install_updates()\e[0m";
    /usr/bin/logger 'install_updates()' -t 'FW-20230914';
    export DEBIAN_FRONTEND=noninteractive;
    ...
    /usr/bin/logger 'install_updates() finished' -t 'FW-20230914';
}

install_ntp_tools() {
    echo -e "\e[32m - install_ntp_tools()\e[0m";
    /usr/bin/logger 'install_ntp_tools()' -t 'FW-20230914';
    export DEBIAN_FRONTEND=noninteractive;
    ...
    /usr/bin/logger 'install_ntp_tools() finished' -t 'FW-20230914';
}

install_ntp() {
    /usr/bin/logger 'install_ntp()' -t 'FW-20230914';
    echo -e "\e[32m - install_ntp()\e[0m";
    export DEBIAN_FRONTEND=noninteractive;
    echo -e "\e[36m ... installing ntp\e[0m";
    apt-get -qq -y install ntp > /dev/null 2>&1
    /usr/bin/logger 'install_ntp() finished' -t 'FW-20230914';
    echo -e "\e[32m - install_ntp() finished\e[0m";
}

configure_ntpsec() {
    /usr/bin/logger 'configure_ntpsec()' -t 'FW-20230914';
    echo -e "\e[32mconfigure_ntpsec()\e[0m";
...
__EOF__
    ...
    /usr/bin/logger 'configure_ntpsec() finished' -t 'FW-20230914';
}

configure_update-leap() {
    /usr/bin/logger 'configure_update-leap()' -t 'FW-20230914';
...
__EOF__
    ...
    /usr/bin/logger 'configure_update-leap() finished' -t 'FW-20230914';
}
configure_iptables() {
    /usr/bin/logger 'configure_iptables()' -t 'FW-20230914';
...
__EOF__
    ...
    cat << __EOF__  >> /etc/network/if-up.d/blockrfc1918
#! /bin/bash
...
__EOF__
    ...
    chmod +x /etc/network/if-up.d/blockrfc1918;
    /usr/bin/logger 'configure_iptables() finished' -t 'FW-20230914';
}

configure_nftables() {
    /usr/bin/logger 'configure_nftables()' -t 'FW-20230914';
    echo -e "\e[32mconfigure_nftables()\e[0m";
    echo -e "\e[32m-Creating nftables rules file\e[0m";
    cat << __EOF__  >> /etc/network/nftables.nft
#
# NFTABLES Ruleset for Debian Based Firewall
# Author: Martin Boller (c) 2016
# bsecure.dk
# Version 1.0 / 2016-04-21 
# Version 1.1 / 2017-01-26
...
add rule ip nat POSTROUTING oifname "enp1s0" ip saddr 192.168.0.0/16 counter masquerade 
add table ip filter
add chain ip filter INPUT { type filter hook input priority 0; policy drop; }
add chain ip filter FORWARD { type filter hook forward priority 0; policy drop; }
add chain ip filter OUTPUT { type filter hook output priority 0; policy drop; }
add chain ip filter LOG_DROPS
add rule ip filter INPUT iifname "enp1s0" counter jump LOG_DROPS
add rule ip filter INPUT iifname "enp1s0" ip saddr 127.0.0.0/8 counter jump LOG_DROPS
add rule ip filter INPUT iifname "enp1s0" ip saddr 10.0.0.0/8 counter jump LOG_DROPS
add rule ip filter INPUT iifname "enp1s0" ip saddr 172.16.0.0/12 counter jump LOG_DROPS
add rule ip filter INPUT iifname "enp1s0" ip saddr 224.0.0.0/4 counter jump LOG_DROPS
add rule ip filter INPUT ip frag-off & 0x1fff != 0 counter jump LOG_DROPS
add rule ip filter INPUT ip ttl lt 4 counter jump LOG_DROPS
add rule ip filter INPUT tcp dport 0 counter jump LOG_DROPS
add rule ip filter INPUT udp dport 0 counter jump LOG_DROPS
add rule ip filter INPUT tcp flags & (fin|syn|rst|psh|ack|urg) == 0x0 counter jump LOG_DROPS
add rule ip filter INPUT tcp flags & (fin|syn|rst|psh|ack|urg) == fin|syn|rst|psh|ack|urg counter jump LOG_DROPS
add rule ip filter INPUT iifname "lo" counter accept
add rule ip filter OUTPUT oifname "enp1s0" udp sport 67-68 counter accept
add rule ip filter OUTPUT tcp dport 5201 counter accept
add rule ip filter INPUT iifname "enp2s0" tcp dport 5201 counter accept
add rule ip filter INPUT iifname "lo" tcp dport 2947 counter accept
add rule ip filter OUTPUT tcp dport 2947 counter accept
add rule ip filter INPUT iifname "lo" tcp dport 8080 counter accept
add rule ip filter OUTPUT tcp dport 8080 counter accept
...
add rule ip filter OUTPUT oifname != "enp1s0" tcp dport 873 counter accept
add rule ip filter INPUT iifname != "enp1s0" tcp dport 853 counter accept
add rule ip filter INPUT iifname "enp1s0" udp dport 123 counter log prefix "ntppeers: " level debug
add rule ip filter INPUT iifname "enp1s0" udp dport 123 counter accept
add rule ip filter OUTPUT oifname "enp1s0" udp sport 123 counter accept
add rule ip filter INPUT iifname != "enp1s0" tcp dport 3128 counter accept
add rule ip filter INPUT iifname != "enp1s0" ip protocol icmp counter accept
add rule ip filter OUTPUT tcp dport 2049 ct state new,related,established  counter accept
add rule ip filter INPUT tcp sport 2049 ct state established  counter accept
add rule ip filter OUTPUT udp dport 2049 ct state new,related,established  counter accept
add rule ip filter INPUT udp sport 2049 ct state established  counter accept
add rule ip filter INPUT iifname "enp2s0" tcp dport 22 counter accept
add rule ip filter INPUT iifname "enp3s0" tcp dport 22 counter accept
add rule ip filter INPUT iifname "enp4s0" tcp dport 22 counter accept
add rule ip filter INPUT iifname "wlp5s0" tcp dport 22 counter accept
add rule ip filter OUTPUT tcp dport 22 counter accept
add rule ip filter INPUT iifname "enp1s0" tcp dport 22 counter jump LOG_DROPS
add rule ip filter INPUT iifname "enp2s0" tcp dport 6055 counter accept
add rule ip filter INPUT iifname "enp3s0" tcp dport 6055 counter accept
add rule ip filter OUTPUT tcp dport 6055 counter accept
add rule ip filter OUTPUT oifname "lo" counter accept
add rule ip filter OUTPUT tcp dport 53 counter accept
add rule ip filter OUTPUT udp dport 53 counter accept
add rule ip filter OUTPUT tcp sport 53 counter accept
add rule ip filter OUTPUT udp sport 53 counter accept
add rule ip filter OUTPUT oifname "enp1s0" tcp dport 43 counter accept
add rule ip filter OUTPUT oifname "enp1s0" tcp dport 80 counter accept
add rule ip filter OUTPUT oifname "enp1s0" udp dport 123 counter accept
add rule ip filter OUTPUT oifname "enp1s0" udp sport 123 counter accept
add rule ip filter OUTPUT oifname "enp1s0" tcp dport 443 counter accept
add rule ip filter OUTPUT oifname "enp1s0" tcp dport 587 counter accept
add rule ip filter OUTPUT oifname "enp1s0" udp sport 67-68 counter accept
add rule ip filter INPUT iifname "enp2s0" udp dport 123 counter accept
add rule ip filter INPUT iifname "enp3s0" udp dport 123 counter accept
add rule ip filter INPUT iifname "enp4s0" udp dport 123 counter accept
add rule ip filter INPUT iifname "wlp5s0" udp dport 123 counter accept
add rule ip filter OUTPUT oifname "enp2s0" udp dport 123 counter accept
add rule ip filter OUTPUT oifname "enp3s0" udp dport 123 counter accept
add rule ip filter OUTPUT oifname "enp4s0" udp dport 123 counter accept
add rule ip filter OUTPUT oifname "wlp5s0" udp dport 123 counter accept
add rule ip filter OUTPUT oifname != "enp1s0" udp dport 68 counter accept
add rule ip filter INPUT ct state related,established  counter accept
add rule ip filter INPUT counter jump LOG_DROPS
add rule ip filter OUTPUT ct state related,established  counter accept
add rule ip filter OUTPUT counter jump LOG_DROPS
add rule ip filter FORWARD iifname != "enp1s0" ip protocol tcp ip saddr 192.168.0.0/16 counter accept
add rule ip filter FORWARD iifname != "enp1s0" ip protocol udp ip saddr 192.168.0.0/16 counter accept
add rule ip filter FORWARD iifname != "enp1s0" ip protocol icmp ip saddr 192.168.0.0/16 counter accept
add rule ip filter FORWARD ct state related,established  counter accept
add rule ip filter FORWARD counter jump LOG_DROPS
add rule ip filter LOG_DROPS ip daddr 255.255.255.255 counter drop
add rule ip filter LOG_DROPS ip daddr 192.168.10.0/24 pkttype broadcast counter drop
add rule ip filter LOG_DROPS ip daddr 192.168.20.0/24 pkttype broadcast counter drop
add rule ip filter LOG_DROPS limit rate 60/second burst 5 packets counter log prefix "iptables: " level debug
add rule ip filter LOG_DROPS counter drop
# Completed on Wed Sep 13 11:49:20 2023
__EOF__
    ...
    cat << __EOF__  >> /etc/network/if-pre-up.d/firewallrules
#!/bin/sh
nft -o -f /etc/network/nftables.nft
exit 0
__EOF__
...
__EOF__
    ...
    chmod +x /etc/network/if-pre-up.d/firewallrules;
    chmod +x /etc/network/if-up.d/blockrfc1918;
    /usr/bin/logger 'configure_nftables() finished' -t 'FW-20230914';
}

configure_interfaces() {
    /usr/bin/logger 'configure_interfaces()' -t 'FW-20230914';
...
__EOF__
    /usr/bin/logger 'configure_interfaces() finished' -t 'FW-20230914';
}
...
__EOF__
    ...
    sync;
    /usr/bin/logger 'configure_motd() finished' -t 'FW-20230914';
}

install_ssh_public_keys() {
    /usr/bin/logger 'install_ssh_keys()' -t 'FW-20230914';
    ...
    sync;
    /usr/bin/logger 'install_SSH_PUBLIC_KEYs() finished' -t 'FW-20230914';
}

configure_sshd() {
    /usr/bin/logger 'configure_sshd()' -t 'FW-20230914';
    ...
    sync;
    /usr/bin/logger 'configure_sshd() finished' -t 'FW-20230914';
}

disable_timesyncd() {
    /usr/bin/logger 'disable_timesyncd()' -t 'FW-20230914';
    echo -e "\e[32mDisable_timesyncd()\e[0m";
    systemctl stop systemd-timesyncd
    systemctl daemon-reload
    systemctl disable systemd-timesyncd
    /usr/bin/logger 'disable_timesyncd() finished' -t 'FW-20230914';
}

configure_dhclient_cleanup() {
    /usr/bin/logger 'configure_dhclient_cleanup()' -t 'FW-20230914';
    echo -e "\e[32mDisable_timesyncd()\e[0m";
...
__EOF__
    ...
    /usr/bin/logger 'configure_dhclient_cleanup() finished' -t 'FW-20230914';
    echo -e "\e[32mconfigure_dhclient_cleanup()\e[0m";

}

configure_dhcp_ntp() {
    /usr/bin/logger 'configure_dhcp_ntp()' -t 'FW-20230914';
    ...
    /usr/bin/logger 'configure_dhcp_ntp() finished' -t 'FW-20230914';
}

finish_reboot() {
    echo -e "\e[1;31m - Countdown to reboot!\e[0m";
    /usr/bin/logger 'Countdown to reboot!' -t 'FW-20230914'
    secs=30;
    echo -e;
    echo -e "\e[1;31m--------------------------------------------\e[0m";
        while [ $secs -gt 0 ]; do
    ...
    /usr/bin/logger 'Rebooting!!' -t 'FW-20230914'
    reboot;
}

configure_grubserial() {
    /usr/bin/logger 'configure_grubserial()' -t 'FW-20230914'
...
configure_hostapd() {
    /usr/bin/logger 'configure_hostapd()' -t 'FW-20230914'
    # Install hostapd
...
install_alerta() {
    /usr/bin/logger 'install_alerta()' -t 'FW-20230914'
    export DEBIAN_FRONTEND=noninteractive;
    ...
    /usr/bin/logger 'install_alerta() finished' -t 'FW-20230914'
}

configure_alerta_heartbeat() {
    /usr/bin/logger 'configure_alerta_heartbeat()' -t 'FW-20230914'
...
__EOF__
    ...
    /usr/bin/logger 'configure_alerta_heartbeat() finished' -t 'FW-20230914'
}
...
echo -e "\e[32m-----------------------------------------------------\e[0m";
echo -e "\e[32mStarting Installation of FW-20230914\e[0m";
echo -e "\e[32m-----------------------------------------------------\e[0m";
echo -e;
...
echo -e "\e[32mInstallation and configuration of FW-20230914 complete.\e[0m";
